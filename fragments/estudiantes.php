...
<body class="fondo">
	...
	<div ><h4>Estudiante</h4>
			<div class="input-group" style="width: 30%">	
				<div style="margin-top: 10px"><p>Código Estudiantil:</p> </div>
					<span class="input-group-addon" style="margin-left: 57px"></span>			
					<input type="text" class="form-control" placeholder="Código" name="cod" required><br>
				
			</div>	
			<div class="input-group">	
				<div style="margin-top: 10px"><p>Nombres:</p> </div>
					<span class="input-group-addon" style="margin-left: 120px"></span>			
					<input type="text" class="form-control" placeholder="Ingrese sus nombres" name="nomb" required><br>
			...
			<div class="input-group">	
				<div style="margin-top: 10px"><p>Documento de Identidad:</p> </div>
					<span class="input-group-addon" style="margin-left: 10px"></span>					
					<div style="width: 35%">							
					<input type="text" class="form-control" placeholder="Ingrese su DNI" name="dni" required><br>
				</div>
